...
const HomeScreen = ({ RenderGame, RenderLeaderBoard }) => {
    return (
        <div className="flex flex-col items-center justify-center align-center gap-3 mt-32 lg:mt-40">
            ...
            <p className="text-center lg:text-xl mx-8 lg:mx-32 lg:mb-4">RoboDash is a match three puzzle game.
                Once the game starts, you will have sixty seconds to score as much as possible
                by matching three or four robots horizontally or vertically.
                The top ten scores will be featured on the leaderboard.<br /> All the best!</p>
